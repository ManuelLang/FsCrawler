...
class PathSkippedEventArgs(PathEventArgs):

    def __init__(self, crawler: ICrawler, path: Path, root_dir_path: str, is_dir: bool, is_file: bool, size: int,
                 root_category: ContentCategory = None, root_min_age: ContentClassificationPegi = None,
                 root_target_table: str = None) -> None:
        super().__init__(crawler, path, root_dir_path, is_dir, is_file, size, root_category, root_min_age,
                         root_target_table)
